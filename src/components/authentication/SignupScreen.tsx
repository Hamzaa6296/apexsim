        ...
        <section className="md:min-h-screen bg-[#181818] px-4 md:px-8 py-6 md:py-12 flex items-center justify-center font-inter">
            <div className="max-w-[1300px] font-manrope w-full grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
                ...
                <div className="hidden lg:flex border border-gray-300/10 rounded-2xl flex-col items-center justify-center relative overflow-hidden">
                    {/* Subtle ambient light to keep it from being too flat */}
                    ...
                    <div className="relative top-20 z-10 w-full max-w-[550px] h-[500px]  flex items-center justify-center">
