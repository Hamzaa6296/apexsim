      ...
      <div className="max-w-325 font-manrope w-full grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
        <div className="bg-[#1f1f1f] rounded-2xl px-4 md:px-10 pt-10 pb-12 flex flex-col justify-start">
          ...
          <div className="flex gap-6 mb-8 relative">
            ...
            >
              Email address
              {loginMethod === 'email' && <div className="absolute bottom-0 left-0 w-full h-0.5 bg-white rounded-full" />}
            </button>
            <button
            ...
            >
              Phone number
              {loginMethod === 'phone' && <div className="absolute bottom-0 left-0 w-full h-0.5 bg-white rounded-full" />}
            </button>
