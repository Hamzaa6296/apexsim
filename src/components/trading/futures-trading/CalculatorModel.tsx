  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Top Tabs - Matches image_6900b7.png underline style */}
          ...
          <div className="flex gap-6">
            {(["Profit/ loss", "Target Price", "Liquidation price"] as CalcTab[]).map((tab) => (
              ...
              >
                {tab}
                {activeTab === tab && (
                  <div className="absolute bottom-[-1px] left-0 w-full h-[2px] bg-[#00B595] shadow-[0_0_8px_rgba(0,181,149,0.4)]" />
                )}
              </div>
            ))}
          </div>
        ...
        <div className="p-4 space-y-5">
          ...
          {/* Leverage Slider Mockup - Matches image_6900b7.png */}
          <div className="pt-2">
             <div className="relative h-1 flex items-center mb-6">
               {/* Main Track Line */}
               <div className="absolute w-full h-[2px] bg-[#2d3036]" />
               {/* Highlighted portion (e.g., up to 1x) */}
               <div className="absolute left-0 w-0 h-[2px] bg-[#00B595]" />
               ...
               <div className="absolute w-full flex justify-between z-10 px-0.5">
                 {[1, 15, 30, 45, 60, 75].map((val) => (
                   <div key={val} className="flex flex-col items-center relative">
                     {/* Diamond Point */}
                     <div className={`w-[8px] h-[8px] rotate-45 border-2 transform translate-y-[-0.5px] ${
