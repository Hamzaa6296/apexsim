            ...
            <div className="relative h-6 flex items-center px-1 cursor-pointer my-1">
                ...
                <div className="absolute w-full flex justify-between z-10">
                    {[0, 25, 50, 75, 100].map((i) => (
                        <div key={i} className={`w-2.5[h-2.5tate-45 rounded-sm border-2 transition-colors ${i === 0 ? 'bg-[#121212] border-[#00B595]' : 'bg-[#121212] border-[#2d3036] hover:border-gray-500'}`} />
                    ))}
                </div>
            </div>
