            ...
            <div className="space-y-3.5">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    {orderType === "Stop limit" && (
                        <div className="h-22x items-center justify-center border border-dashed border-white/10 rounded-md">
                ...
                <div className="relative h-6 flex items-center mt-2 px-1 cursor-pointer">
                    <div className="absolute w-full h-0.5g-[#2d3036] rounded" />
                    <div className="absolute w-full flex justify-between z-10">
                        {[0, 1, 2, 3].map((i) => (
                            <div
                                key={i}
                                className={`w-3.75-h-3.75otate-45 rounded-sm border-3 ${i === 0
                ...
                <button className={`w-full py-3 rounded-md  text-[16px] cursor-pointer transition-all active:scale-[0.98] ${side === 'buy'
                    ? 'bg-linear-to-rrom-[#0052ff] to-[#0070ff] text-white shadow-[0_4px_12px_rgba(0,82,255,0.3)]'
