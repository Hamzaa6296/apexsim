...
import { FaChevronDown, FaQuestionCircle, FaWallet, FaRegBell, FaSun, FaCreditCard, FaCaretDown } from "react-icons/fa";
    ...
    return (
        <div className="max-w-full mx-auto px-4 md:px-30 md:py-10 py-5 font-manrope min-h-screen text-white">
            ...
            <div className="flex items-center md:px-0 px-4 justify-between md:mb-10 mb-4">
                <h1 className="md:text-4xl text-xl font-semibold font-manrope tracking-tight">Convert</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 md:gap-10 gap-5 mb-16 items-stretch">
                ...
                <div className="bg-[#202020] rounded-3xl flex items-center justify-center p-15 border border-white/5 min-h-[450px]">
                    <img
                        src="/images/convert.png"
                        alt="Deposit Illustration"
                        className="w-full max-w-[340px] py-10 object-contain drop-shadow-2xl"
                    />
                </div>

                {/* RIGHT: Deposit Form Section (Updated to match image_bbacc0.png) */}
                    ...
                    <div className="space-y-4 flex-1">
                        ...
                        <div className="bg-[#252525] px-4 py-3 rounded-lg border border-white/5">
                            <div className="flex justify-between items-center">
                                ...
                                <span className="text-gray-50 flex items-center justify-center gap-1 text-[13px]">Available: 0 BTC <img src="/images/plus.png" className='w-3 h-3' alt="" /></span>
                            </div>
                            <div className="flex justify-between items-center">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    />
                                    <span className="text-gray-500 font-bold text-lg underline border-l pl-3 border-l-gray-700 !cursor-pointer hover:text-white transition-colors">Max</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="pt-4 border-t border-white/5 space-y-4">
                            <div className="flex justify-between items-center">
                                <span className="text-gray-500 text-lg font-medium">Transaction fees</span>
                                <span className="text-white font-bold text-md">0 fees</span>
                            </div>
                            <div className="flex justify-between items-center">
                                <span className="text-gray-500 text-lg font-medium">You'll get</span>
            ...
            <div className="mt-8">
                <h2 className="text-xl font-semibold text-white mb-8">Recent Convert</h2>
