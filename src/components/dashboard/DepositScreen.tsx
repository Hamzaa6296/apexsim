...
import { FaQuestionCircle, FaCreditCard } from "react-icons/fa";

import { FaCaretDown } from "react-icons/fa";
import { useRouter } from 'next/navigation';

const coins = [
    { id: 'btc', name: 'BTC', icon: '/images/bitcoin.png' },
    { id: 'sol', name: 'SOL', icon: '/images/doge.png' },
    { id: 'eth', name: 'ETH', icon: '/images/etherium.png' },
    { id: 'usdt', name: 'USDT', icon: '/images/tcoin.png' },
];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 md:gap-10 gap-5 mb-16 items-stretch">
                ...
                <div className="bg-[#202020] rounded-3xl flex items-center justify-center p-12 border border-white/5 min-h-112.5">
                    <img
                        ...
                        className="w-full max-w-85 object-contain drop-shadow-2xl"
                    />
                </div>
                    ...
                    {depositType === 'crypto' ? (
                        ...
                        <div className="space-y-0">
                            <div className="relative pb-6 pl-8 border-l border-dashed border-white/10">
                                <span className="absolute md:-left-4 -left-2.5 top-0 md:w-8 md:h-8 h-6 w-6 rounded-full bg-[#252525] border border-white/10 flex items-center justify-center md:text-[15px] text-[12px] text-white font-bold">1</span>
                            ...
                            <div className="relative pb-6 pl-8 border-l border-dashed border-white/10">
                                <span className="absolute md:-left-4 -left-2.5 top-0 md:w-8 md:h-8 h-6 w-6 rounded-full bg-[#252525] border border-white/10 flex items-center justify-center md:text-[15px] text-[12px] text-white font-bold">2</span>
                            ...
                            <div className="relative pl-8">
                                <span className="absolute md:-left-4 -left-2.5 top-0 md:w-8 md:h-8 h-6 w-6 rounded-full bg-[#252525] border border-white/10 flex items-center justify-center md:text-[15px] text-[12px] text-white font-bold">3</span>
