...
export default function MarketComponent() {
    ...
    const getMarketContent = (category: string) => {
        ...
        return {
            cards: [
                { pair: "BTC / USDT", price: "$88,259.95", vol: "24h Vol $16,585,576", icons: ["https://cryptologos.cc/logos/bitcoin-btc-logo.png"] },
                { pair: "ETH / USDT", price: "$2,959.95", vol: "24h Vol $12,585,576", icons: ["https://cryptologos.cc/logos/ethereum-eth-logo.png"] },
                { pair: "AVAX / USDT", price: "$36.36", vol: "24h Vol $2,585,576", icons: ["https://cryptologos.cc/logos/avalanche-avax-logo.png"] },
                { pair: "SOL / USDT", price: "$126.10", vol: "24h Vol $5,585,576", icons: ["https://cryptologos.cc/logos/solana-sol-logo.png"] },
            ],
            table: [
                { pair: "BTC/USDT", price: "$89,846", change: "+4.90%", high: "$91,000", low: "$88,000", volume: "1.7 B", icons: ["https://cryptologos.cc/logos/bitcoin-btc-logo.png"] },
                { pair: "ETH/USDT", price: "$2,959", change: "+2.10%", high: "$3,050", low: "$2,850", volume: "800 M", icons: ["https://cryptologos.cc/logos/ethereum-eth-logo.png"] },
                { pair: "XRP/USDT", price: "$0.54", change: "+1.20%", high: "$0.56", low: "$0.52", volume: "400 M", icons: ["https://cryptologos.cc/logos/xrp-xrp-logo.png"] },
            ]
        };
    };
