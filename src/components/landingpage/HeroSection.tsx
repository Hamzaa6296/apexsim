...
const ALL_CARDS = [
    ...
    { symbol: "Amazon", price: "2,90.35", change: "-2.84%", imageUrl: "/images/amazon.png" },
    { symbol: "S&P 500", price: "1.05", change: "+1.01%", imageUrl: "/images/fivehundred.png" },
    { symbol: "USD/JPY", price: "0.005", change: "-0.01%", imageUrl: "/images/twoflags.png" },
    { symbol: "Crude Oil", price: "40.89", change: "+1.01%", imageUrl: "/images/oilcontainer.png" },
    { symbol: "Gold", price: "45,596", change: "-0.01%", imageUrl: "/images/mountain.png" },
];
