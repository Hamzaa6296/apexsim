  ...
  const faqData = [
    {
      ...
      answer: "ApexSim is a private paper trading platform built for simulation and education. It allows users to practice trading across multiple markets using virtual funds, realistic charts, and simulated trade execution. All activity on ApexSim is visual and educational only; there is no real money, no live brokerage connection, and no real trade execution."
    },
    {
      question: "Is ApexSim a real trading platform or broker?",
      answer: "No, ApexSim is strictly a simulation environment. We do not hold licenses to act as a financial broker, and you cannot place real-market trades through our interface."
    },
    {
      question: "Do I use real money on ApexSim?",
      answer: "Never. ApexSim uses virtual currency for all simulations. This allows you to test strategies and learn market movements without any financial risk."
    },
    {
      question: "Who is ApexSim designed for?",
      answer: "It is designed for beginners who want to learn the basics of trading and experienced traders who want to backtest new strategies in a risk-free environment."
    },
    {
      question: "Can I withdraw money from ApexSim?",
      answer: "Since all funds are virtual and used only for educational simulation, there is no real balance to withdraw."
    }
  ];
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-400 text-base md:text-md max-w-lg mx-auto">
            Everything you need to know about keeping your assets safe, simple, and secure with APEXSIM
          </p>
        </div>
