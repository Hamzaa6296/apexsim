...
const FeatureCard = ({ title, imageSrc, orderClass }: FeatureCardProps) => (
    <div className={`flex flex-col items-center justify-center py-10 px-6 border-r border-b border-white/15 hover:bg-white/1 transition-colors text-center group ${orderClass} md:order-0`}>
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className='flex items-center justify-center md:mb-20'>
                    <div className="grid grid-cols-2 lg:grid-cols-3 max-w-5xl w-full border border-white/15 overflow-hidden ">
                        ...
                        <div className="col-span-2 md:col-span-1 order-2 md:order-0 bg-linear-to-tr from-blue-600 to-blue-500 flex flex-col rounded-lg items-center justify-center py-10 px-6 text-center relative overflow-hidden group border-r border-b border-white/15">
